    ...
    var instructions = new InstructionsSubsectionsBlock(
            {
                ...
                mainInstructions: ['Thanks for your interest in our study! We are trying to understand how people comprehend speech. In this study, you will listen to speech sounds and make a decision about what you hear. Your response will provide critical information that helps us to advance speech technology.',
                				   'This experiment will take about 15 to 20 minutes and you will be paid $2.50.',
    ...
    /*Rest of the experiment here*/
        ...
        var instructions_0 = new InstructionsSubsectionsBlock(
            {
               ...
               // instrStyle: 'logo2',
                ...
                mainInstructions: [
                                   ...
                                   '<span style="font-weight:bold;">In both tasks, you can respond as soon as the audio play finishes. Please respond <u>as accurately and as quickly as possible</u>. Your performance will be tracked throughout the experiment. You will get an additional $.5 bonus payment if you scored 80% correct or more.',
       ...
       var sampleStimLD = new ExtendedStimuliFileList(
        ...
        if (condition === "native_control") {
            training1Prefix = "../stimuli/LD/English_speaker_from_Babel/";
            training2Prefix = "../stimuli/LD/English_speaker_from_Babel/";
            //practicePrefix = "../stimuli/Test/Mandarin_speaker5/";
            test2Prefix = "../stimuli/Test/Mandarin_speaker5/";

            training1List = "../lists/Training/native_accented/Training1_List_"+condition+"_"+TrL+".txt";
            training2List = "../lists/Training/native_accented/Training2_List_"+condition+"_"+TrL+".txt";
           // practiceList = "../lists/Test0.txt";
            test2List = "../lists/Test/Test2_List"+TeL+".txt";
        }
           ...
           var instructions_block2 = new InstructionsSubsectionsBlock(
            {
                instrImg: '../img/LD_task_B12.png',
                instrStyle: 'logo2',
                title: '<span style="font-weight:bold;"><font color="orange">Block 1: Word or not?</font></span>',
                mainInstructions: ["<p>You are done with the practice. Now the real experiment begins and you will hear a different speaker. </p>",
                                   "<p>In Block 1, you will complete the <font color='orange'>'Word or not'</font> task. </p>",
           ...
           var instructions_block3 = new InstructionsSubsectionsBlock(
            {
                ...
                mainInstructions: ["<p>You have completed Block 1.</p>",
                                   "<p>Block 2 will be the same, only that you will hear different words. You will hear speech from the same voice. </p>",
                                 //  "<p><span style='font-weight:bold;'>Respond as quickly as possible without sacrificing accuracy. We encourage you to keep your fingers on the two keys ('D' and 'T') throughout this part.</span></p>", 
                   ],
