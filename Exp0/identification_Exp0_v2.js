    ...
    var instructions = new InstructionsSubsectionsBlock(
            {
                ...
                subsections: [
                                ...
                                {
                                    title: 'Sound check',
                                    content: ['Press each green button to play a word, and enter it in the space provided in all lowercase letters. Set your volume to a comfortable listening level so that you can clearly and easily hear the words. It is important that you <span style="font-weight:bold;">do not</span> change your volume during the actual experiment.',
                                              function() {
